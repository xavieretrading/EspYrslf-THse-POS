          ...
          <div className="bg-slate-50 rounded-2xl shadow-2xl max-w-[420px] w-full max-h-[92vh] flex flex-col overflow-hidden border border-slate-200">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-sm leading-tight">
                    {receiptData.status === 'open' ? 'Order Summary' : 'Receipt Preview'}
                  </h3>
                    ...
                    return (
                      <div className="relative print:relative text-black receipt-ticket-content">
                        ...
                        <div className="section-block border-t border-dashed border-black pt-2 mt-2 font-mono text-[10pt] space-y-1">
                          <div className="flex justify-between row-item">
                            <span>Subtotal:</span>
                            <span>₱{(laundryDetails.subtotal || 0).toFixed(2)}</span>
                          </div>
                          <div className="flex justify-between row-item font-black text-[15pt] pt-1">
                            <span>TOTAL</span>
                    ...
                    <div className="relative print:relative receipt-ticket-content">
                      ...
                      <div className="section-block border-t border-dashed border-black pt-1.5 mt-1">
                        ...
                        {receiptData.discount_amount > 0 && (
                          <div className="flex justify-between row-item font-bold">
                            <span>Less: {receiptData.discount_name || 'Discount'}</span>
                      ...
                      <div className="section-block pt-1 text-center">
                        <p className="row-item text-center">
                          {receiptData.table_name || 'Dine In'} • Guests: {receiptData.pax_count || 1} • Items: {receiptData.items?.reduce((acc: number, item: any) => acc + item.quantity, 0)}
                        </p>
                      </div>
            ...
            <div className="p-3 bg-white border-t border-slate-200 shrink-0 space-y-2.5 print:hidden">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Printer size={15} /> {receiptData.status === 'open' ? 'Print Summary' : 'Print Receipt'}
                </button>
              </div>
            </div>
          </div>
